...
saveResults <- function(resultObject){
    ...
    fileName <- paste(resultObject$projectName, "_", "integrals", ".csv", sep="")
    write.csv(intg, fileName, quote = FALSE)
}
